...
function addInventory(item,numberadd) {
item.inventory += numberadd;
console.log(numberadd + " items of "+item.name+" added to the inventory");
...
In this example, "chair" is the name of the product.
*/
function processSale(item,numbersold) {
  var sale;
  item.inventory -= numbersold;
  sale = item.unit_price * numbersold;
  console.log(numbersold + " loaves of "+item.name+" sold, "+item.inventory+" remaining");
  return sale;
}
